...
public class OrderService {
    ...
    public OrderDetailResponse getOrder(String orderId) {
        ...
        return OrderDetailResponse.builder()
                ...
                .payment(payment
                        .map(value -> new OrderPaymentDetailResponse(value.getAmount(), "toss"))
                        .orElse(null))
                .build();
    }
    ...
    public void confirmPurchase(Long memberId, String orderId, Long orderItemId) {
        OrderItem orderItem = orderItemRepository.findByIdAndOrder_IdAndOrder_Member_Id(orderItemId, orderId, memberId)
                .orElseThrow();
        // 상태검증
